<template>
  ...
  <section v-show="activeTab === 'events'" class="mx-auto w-full max-w-2xl px-4 sm:px-6">
    <p class="rounded-3xl border-t-4 border-t-sunlight border border-primary/10 bg-surface px-6 py-5 leading-loose text-body shadow-sm">
      今後の活動予定は、<a
        class="text-accent-strong underline underline-offset-2 hover:opacity-80"
